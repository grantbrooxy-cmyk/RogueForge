...
| Quest step flag coverage | Every step has a completion mechanism | `Complete` | Python cross-validation confirms all completionWorldFlag values are set by dialogue, story events, or TMX/world interactions | None — all chains verified |

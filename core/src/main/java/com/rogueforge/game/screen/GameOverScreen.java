...
public class GameOverScreen implements Screen {
    ...
    public GameOverScreen(
        ...
        this.metaProgressionManager = metaProgressionManager != null ? metaProgressionManager : engineServices.getMetaProgressionManager();
        this.cyberneticEnhancementEngine = cyberneticEnhancementEngine != null ? cyberneticEnhancementEngine : engineServices.getCyberneticEnhancementEngine();
